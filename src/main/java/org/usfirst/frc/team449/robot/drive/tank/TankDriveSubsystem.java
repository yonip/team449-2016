...
public class TankDriveSubsystem extends DriveSubsystem {
	...
	/**
	 * Instantiate a new <code>TankDriveSubsystem</code>
	 */
	public TankDriveSubsystem() {
		...
		Encoder enc = new Encoder(TankDriveMap.Encoders.RIGHT.A, TankDriveMap.Encoders.RIGHT.B);
		enc.setDistancePerPulse(TankDriveMap.Encoders.RIGHT.DPP);
		rightCluster = new PIDPositionMotor(TankDriveMap.P, TankDriveMap.I, TankDriveMap.D, mc, enc);
		...
		mc.setInverted(true);
		enc = new Encoder(TankDriveMap.Encoders.LEFT.A, TankDriveMap.Encoders.LEFT.B);
		enc.setDistancePerPulse(TankDriveMap.Encoders.LEFT.DPP);
		leftCluster = new PIDPositionMotor(TankDriveMap.P, TankDriveMap.I, TankDriveMap.D, mc, enc);
