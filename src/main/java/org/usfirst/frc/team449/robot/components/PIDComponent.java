...
/**
 * A class designed for PID subsystems not linked to commands and that are parts of more complex subsystems
 * Should be the super class for all PID based classes in components packages
 */
